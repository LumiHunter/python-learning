...
GIL: Global Interpreter Lock
    (1) CPython이 코드를 해석하여 Python(bytecode) 실행 시 여러 스레드 사용할 경우, 단일 스레드만이 Python object에 접근하게 제한하는 mutex
    ...
    (6) 스레드 동시성 완벽처리를 위해 -> Jython, IronPython, Stackless Python 등이 존재.
"""